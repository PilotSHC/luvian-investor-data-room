...
The path from Luvian Labs LLC today to the Delaware C-corporation that will hold the cap table at Series A. Investors and counsel see this plan in advance so the path is fully visible at the time the Convertible Note is signed.

**Trigger:** Earlier of (a) lead investor commitment to the Convertible Note round, or (b) demand for institutional priced equity.
**Estimated cost:** $2,500 – $5,000 (counsel fees plus filing fees).
