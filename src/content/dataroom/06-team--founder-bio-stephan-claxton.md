...
Two co-founders plus our first software engineer. Each owns a distinct surface of the company. The round funds the next three hires beyond the current team.
...
* Experience spanning aerospace, automotive, and enterprise engineering workflows
* Deep expertise in engineering traceability, ontology design, and operational context modeling
* Formerly worked on advanced autonomy and engineering infrastructure initiatives at Applied Intuition
* Building Luvian to enable trustworthy AI reasoning across complex engineering organizations

The combination of systems engineering depth, defense-program delivery experience, and autonomous-vehicle verification work places Stephan at the intersection of three regulated industries that almost no one else has lived inside. That cross-domain fluency is the founder market fit thesis.
...
He joined Luvian in March 2026 to translate that lived engineering experience into product strategy, with a clear conviction: the best tools for engineers are built by those who are practitioners themselves.
...
Top three roles for the round, in priority order.

1. **GTM lead.** Pre-sales and design-partner engagement in defense, aerospace, and autonomous vehicles.
2. **Founding ML and AI engineer.** Owns retrieval, evaluation, and the local-first reasoning stack.
3. **Second software engineer.** Owns the context graph, ontology, and provenance primitives alongside Colin.

Detail on scope, compensation, and equity is in the *Hiring Plan* document elsewhere in this section. References available on request after the first call.
